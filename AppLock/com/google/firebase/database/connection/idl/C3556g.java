...
public interface C3556g extends IInterface {

    public static abstract class C3557a extends Binder implements C3556g {

        private static class C3566a implements C3556g {
            ...
            public String mo4307a() {
                ...
                try {
                    ...
                    this.f12169a.transact(1, obtain, obtain2, 0);
            ...
            public boolean mo4308b() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.firebase.database.connection.idl.IListenHashProvider");
                    this.f12169a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public zza mo4309c() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.firebase.database.connection.idl.IListenHashProvider");
                    this.f12169a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        public static C3556g m15520a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C3556g)) ? new C3566a(iBinder) : (C3556g) queryLocalInterface;
        }
