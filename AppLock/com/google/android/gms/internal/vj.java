...
public interface vj extends IInterface {
    ...
    public static abstract class C2355a extends Binder implements vj {

        private static class C3360a implements vj {
            private IBinder f11012a;

            C3360a(IBinder iBinder) {
                this.f11012a = iBinder;
            }
            ...
            public void finishPurchase() {
                ...
                try {
                    ...
                    this.f11012a.transact(5, obtain, obtain2, 0);
            ...
            public String getProductId() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                    this.f11012a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public Intent getPurchaseData() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                    this.f11012a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public int getResultCode() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                    this.f11012a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public boolean isVerified() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.purchase.client.IInAppPurchaseResult");
                    this.f11012a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        public static vj zzaa(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof vj)) ? new C3360a(iBinder) : (vj) queryLocalInterface;
        }
