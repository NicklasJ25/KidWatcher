...
@wh
public class su extends sr {
    private static final Set<String> f10606d = Collections.synchronizedSet(new HashSet());
    private static final DecimalFormat f10607e = new DecimalFormat("#,###");
    private File f10608f;
    private boolean f10609g;

    public su(aat com_google_android_gms_internal_aat) {
        super(com_google_android_gms_internal_aat);
        File cacheDir = this.a.getCacheDir();
        if (cacheDir == null) {
            aad.m8426e("Context.getCacheDir() returned null");
            return;
        }
        this.f10608f = new File(cacheDir, "admobVideoStreams");
        String str;
        String valueOf;
        if (!this.f10608f.isDirectory() && !this.f10608f.mkdirs()) {
            str = "Could not create preload cache directory at ";
            valueOf = String.valueOf(this.f10608f.getAbsolutePath());
            aad.m8426e(valueOf.length() != 0 ? str.concat(valueOf) : new String(str));
            this.f10608f = null;
        } else if (!this.f10608f.setReadable(true, false) || !this.f10608f.setExecutable(true, false)) {
    ...
    private File m13758a(File file) {
        return new File(this.f10608f, String.valueOf(file.getName()).concat(".done"));
    }

    private static void m13759b(File file) {
        if (file.isFile()) {
    ...
    public boolean mo4015a(java.lang.String r27) {
        /*
        r26 = this;
        r0 = r26;
        r2 = r0.f10608f;
    ...
    L_0x0006:
        ...
        r0 = r26;
        r1 = r27;
        r0.m13753a(r1, r2, r3, r4);
        r2 = 0;
    L_0x0012:
        return r2;
    L_0x0013:
        r3 = r26.m13762c();
        r2 = com.google.android.gms.internal.qb.f10304q;
        r2 = r2.m13225c();
    ...
    L_0x00bd:
        com.google.android.gms.internal.aad.m8426e(r2);	 Catch:{ all -> 0x00d2 }
        r2 = r12.getAbsolutePath();	 Catch:{ all -> 0x00d2 }
        r4 = "inProgress";
        r5 = 0;
        r0 = r26;
        r1 = r27;
        r0.m13753a(r1, r2, r4, r5);	 Catch:{ all -> 0x00d2 }
        r2 = 0;
    ...
    L_0x00e2:
        ...
        r10 = "error";
        r9 = 0;
        r3 = com.google.android.gms.ads.internal.zzw.zzcZ();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = com.google.android.gms.internal.qb.f10310w;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r2.m13225c();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r0 = r27;
        r3 = r3.m8451a(r0, r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x015c:
        r6 = com.google.android.gms.ads.internal.zzw.zzcQ();
    ...
    L_0x01ec:
        com.google.android.gms.internal.aad.m8426e(r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r12.getAbsolutePath();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r3 = "contentLengthMissing";
        r4 = 0;
        r0 = r26;
        r1 = r27;
        r0.m13753a(r1, r2, r3, r4);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = f10606d;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x020b:
        ...
        goto L_0x0158;
    L_0x0210:
        r2 = f10607e;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r2 = com.google.android.gms.internal.qb.f10305r;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r2.m13225c();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = (java.lang.Integer) r2;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
    ...
    L_0x026a:
        ...
        r0 = r26;
        r1 = r27;
        r0.m13753a(r1, r3, r4, r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = f10606d;	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2.remove(r8);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = 0;
        goto L_0x0012;
    ...
    L_0x028a:
        ...
        r2 = r2.append(r0);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        r2 = r2.toString();	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        com.google.android.gms.internal.aad.m8421b(r2);	 Catch:{ IOException -> 0x020b, RuntimeException -> 0x0285 }
        ...
        r18 = com.google.android.gms.ads.internal.zzw.zzcS();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r5 = 0;
        r20 = r18.mo3360a();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = com.google.android.gms.internal.qb.f10309v;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = r2.m13225c();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        ...
        r19 = new com.google.android.gms.internal.zw;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r0 = r19;
        r0.<init>(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = com.google.android.gms.internal.qb.f10308u;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = r2.m13225c();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = (java.lang.Long) r2;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x033f:
        ...
        r2 = r18.mo3360a();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = r2 - r20;
    ...
    L_0x0389:
        r0 = r26;
        r2 = r0.f10609g;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x0399:
        ...
        goto L_0x0158;
    L_0x039e:
        r2 = r19.m15282a();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x03a4:
        ...
        r2 = r26;
        r3 = r27;
        r2.m13752a(r3, r4, r5, r6, r7);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        goto L_0x02fe;
    L_0x03b2:
        r2 = move-exception;
        r3 = r9;
    ...
    L_0x03b8:
        ...
        r2 = 3;
        r2 = com.google.android.gms.internal.aad.m8420a(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        if (r2 == 0) goto L_0x03fe;
    L_0x03c2:
        r2 = f10607e;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        ...
        com.google.android.gms.internal.aad.m8421b(r2);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    L_0x03fe:
        r2 = 1;
        r3 = 0;
        r12.setReadable(r2, r3);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        m13759b(r13);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = r12.getAbsolutePath();	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r0 = r26;
        r1 = r27;
        r0.m13751a(r1, r2, r5);	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
        r2 = f10606d;	 Catch:{ IOException -> 0x03b2, RuntimeException -> 0x0457 }
    ...
    L_0x0419:
        ...
        r5 = r5.append(r6);
        r5 = r5.toString();
        com.google.android.gms.internal.aad.m8424c(r5, r2);
        goto L_0x0196;
    L_0x0443:
        r2 = new java.lang.String;
        r2.<init>(r5);
    ...
    L_0x0457:
        ...
        goto L_0x0158;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.su.a(java.lang.String):boolean");
    }
    ...
    public int m13762c() {
        ...
        if (this.f10608f != null) {
            for (File name : this.f10608f.listFiles()) {
    ...
    public boolean m13763d() {
        ...
        File[] listFiles = this.f10608f.listFiles();
