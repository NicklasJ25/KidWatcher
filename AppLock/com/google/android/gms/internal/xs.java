...
public interface xs extends IInterface {
    ...
    public static abstract class C3155a extends Binder implements xs {

        private static class C3443a implements xs {
            private IBinder f11442a;

            C3443a(IBinder iBinder) {
            ...
            public void mo3887a(C2309a c2309a) {
                ...
                try {
                    ...
                    this.f11442a.transact(9, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo3888a(xu xuVar) {
                ...
                try {
                    ...
                    this.f11442a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo3890a(String str) {
                ...
                try {
                    ...
                    this.f11442a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo3891b(C2309a c2309a) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    obtain.writeStrongBinder(c2309a != null ? c2309a.asBinder() : null);
                    this.f11442a.transact(10, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo3894c(C2309a c2309a) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    obtain.writeStrongBinder(c2309a != null ? c2309a.asBinder() : null);
                    this.f11442a.transact(11, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void mo3896e() {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    this.f11442a.transact(8, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static xs m13182a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof xs)) ? new C3443a(iBinder) : (xs) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    mo3889a(parcel.readInt() != 0 ? (zzoa) zzoa.CREATOR.createFromParcel(parcel) : null);
                ...
                case 3:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    mo3888a(C3268a.m13803a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 4:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    mo3890a(parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 5:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                ...
                case 9:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    mo3887a(C2311a.m7326a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 10:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    mo3891b(C2311a.m7326a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 11:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.reward.client.IRewardedVideoAd");
                    mo3894c(C2311a.m7326a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void mo3887a(C2309a c2309a);

    void mo3888a(xu xuVar);

    void mo3889a(zzoa com_google_android_gms_internal_zzoa);

    void mo3890a(String str);

    void mo3891b(C2309a c2309a);

    boolean mo3892b();

    void mo3893c();

    void mo3894c(C2309a c2309a);
