...
public interface oo extends IInterface {
    ...
    public static abstract class C3110a extends Binder implements oo {

        private static class C3125a implements oo {
            private IBinder f10137a;

            C3125a(IBinder iBinder) {
            ...
            public void mo3852a() {
                ...
                try {
                    ...
                    this.f10137a.transact(1, obtain, obtain2, 0);
        ...
        public static oo m12868a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof oo)) ? new C3125a(iBinder) : (oo) queryLocalInterface;
        }
