...
public interface oy extends IInterface {
    ...
    public static abstract class C2397a extends Binder implements oy {

        private static class C3137a implements oy {
            private IBinder f10147a;

            C3137a(IBinder iBinder) {
                this.f10147a = iBinder;
            }
            ...
            public void initialize() {
                ...
                try {
                    ...
                    this.f10147a.transact(1, obtain, obtain2, 0);
            ...
            public void setAppMuted(boolean z) {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f10147a.transact(4, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void setAppVolume(float f) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    obtain.writeFloat(f);
                    this.f10147a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzb(C2309a c2309a, String str) {
                ...
                try {
                    ...
                    this.f10147a.transact(5, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzc(String str, C2309a c2309a) {
                ...
                try {
                    ...
                    obtain.writeString(str);
                    obtain.writeStrongBinder(c2309a != null ? c2309a.asBinder() : null);
                    this.f10147a.transact(6, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
            ...
            public void zzy(String str) {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    obtain.writeString(str);
                    this.f10147a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static oy zzu(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof oy)) ? new C3137a(iBinder) : (oy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 5:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    zzb(C2311a.m7326a(parcel.readStrongBinder()), parcel.readString());
                    parcel2.writeNoException();
                    return true;
                case 6:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.client.IMobileAdsSettingManager");
                    zzc(parcel.readString(), C2311a.m7326a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
    ...
    void zzb(C2309a c2309a, String str);

    void zzc(String str, C2309a c2309a);
