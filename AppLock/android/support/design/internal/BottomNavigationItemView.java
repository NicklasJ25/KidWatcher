...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0006R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0006R.drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0006R.id.icon);
        this.mSmallLabel = (TextView) findViewById(C0006R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0006R.id.largeLabel);
    }
