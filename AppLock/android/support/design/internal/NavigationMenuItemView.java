...
public class NavigationMenuItemView extends ForegroundLinearLayout implements ItemView {
    ...
    class C00091 extends AccessibilityDelegateCompat {
        C00091() {
        }
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAccessibilityDelegate = new C00091();
        setOrientation(0);
        LayoutInflater.from(context).inflate(C0006R.layout.design_navigation_menu_item, this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(C0006R.dimen.design_navigation_icon_size);
        this.mTextView = (CheckedTextView) findViewById(C0006R.id.design_menu_item_text);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(C0280R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(C0006R.id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), C0006R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
