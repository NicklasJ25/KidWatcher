...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mMaxWidth = obtainStyledAttributes.getDimensionPixelSize(C0006R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = obtainStyledAttributes.getDimensionPixelSize(C0006R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    protected void onFinishInflate() {
        ...
        this.mMessageView = (TextView) findViewById(C0006R.id.snackbar_text);
        this.mActionView = (Button) findViewById(C0006R.id.snackbar_action);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0006R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C0006R.dimen.design_snackbar_padding_vertical);
