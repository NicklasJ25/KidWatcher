...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C00121 implements OnApplyWindowInsetsListener {
        C00121() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0006R.styleable.ScrimInsetsFrameLayout, i, C0006R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = obtainStyledAttributes.getDrawable(C0006R.styleable.ScrimInsetsFrameLayout_insetForeground);
        obtainStyledAttributes.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C00121());
    }
