...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final OnClickListener mOnClickListener = new C00101();
    ...
    private static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup, OnClickListener onClickListener) {
            super(layoutInflater.inflate(C0006R.layout.design_navigation_item, viewGroup, false));
    ...
    private static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0006R.layout.design_navigation_item_separator, viewGroup, false));
        }
    }

    private static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(C0006R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }
    ...
    public MenuView getMenuView(ViewGroup viewGroup) {
        if (this.mMenuView == null) {
            this.mMenuView = (NavigationMenuView) this.mLayoutInflater.inflate(C0006R.layout.design_navigation_menu, viewGroup, false);
            if (this.mAdapter == null) {
                this.mAdapter = new NavigationMenuAdapter();
            }
            this.mHeaderLayout = (LinearLayout) this.mLayoutInflater.inflate(C0006R.layout.design_navigation_item_header, this.mMenuView, false);
    ...
    public void initForMenu(Context context, MenuBuilder menuBuilder) {
        ...
        this.mPaddingSeparator = context.getResources().getDimensionPixelOffset(C0006R.dimen.design_navigation_separator_vertical_padding);
    }
