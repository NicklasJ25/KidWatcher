...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mInactiveItemMaxWidth = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = resources.getDimensionPixelSize(C0006R.dimen.design_bottom_navigation_height);
        ...
        this.mOnClickListener = new C00071();
    ...
    public void updateMenuView() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            this.mButtons[i2].initialize((MenuItemImpl) item, 0);
            this.mPresenter.setUpdateSuspended(false);
        }
