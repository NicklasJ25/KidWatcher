...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    static final Handler sHandler = new Handler(Looper.getMainLooper(), new C00171());
    private final AccessibilityManager mAccessibilityManager;
    private List<BaseCallback<B>> mCallbacks;
    private final ContentViewCallback mContentViewCallback;
    private final Context mContext;
    private int mDuration;
    final Callback mManagerCallback = new C00193();
    ...
    static class C00171 implements Callback {
        C00171() {
        }
    ...
    class C00182 implements OnApplyWindowInsetsListener {
        C00182() {
        }
    ...
    class C00193 implements Callback {
        C00193() {
        }
    ...
    class C00204 implements OnDismissListener {
        C00204() {
        }
    ...
    class C00225 implements OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View view) {
            if (BaseTransientBottomBar.this.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new C00211());
            }
        }
    }
    ...
    class C00236 implements OnLayoutChangeListener {
        C00236() {
        }
    ...
    class C00247 extends ViewPropertyAnimatorListenerAdapter {
        C00247() {
        }
    ...
    class C00258 implements AnimationListener {
        C00258() {
        }
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0006R.styleable.SnackbarLayout);
            if (obtainStyledAttributes.hasValue(C0006R.styleable.SnackbarLayout_elevation)) {
                ViewCompat.setElevation(this, (float) obtainStyledAttributes.getDimensionPixelSize(C0006R.styleable.SnackbarLayout_elevation, 0));
            }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            this.mView = (SnackbarBaseLayout) LayoutInflater.from(this.mContext).inflate(C0006R.layout.design_layout_snackbar, this.mTargetParent, false);
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C00182());
    ...
    private void animateViewOut(final int i) {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0006R.anim.design_snackbar_out);
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C00247()).start();
            return;
        }
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0006R.anim.design_snackbar_in);
        loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        loadAnimation.setDuration(250);
        loadAnimation.setAnimationListener(new C00258());
        this.mView.startAnimation(loadAnimation);
    }
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C00204());
                layoutParams2.setBehavior(behavior);
                layoutParams2.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C00225());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C00236());
