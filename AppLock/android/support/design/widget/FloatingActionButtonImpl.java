...
abstract class FloatingActionButtonImpl {
    ...
    class C00451 implements OnPreDrawListener {
        C00451() {
        }
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00451();
        }
    }
    ...
    CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C0006R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0006R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0006R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0006R.color.design_fab_stroke_end_outer_color));
