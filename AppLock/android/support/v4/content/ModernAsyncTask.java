...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C01231();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C01242();

    static class C01231 implements ThreadFactory {
    ...
    class C01242 extends WorkerRunnable<Params, Result> {
        C01242() {
        }
