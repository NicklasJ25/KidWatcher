...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] COLUMNS = new String[]{"_display_name", Columns.CONTENT_SIZE};
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
            } catch (IOException e) {
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        while (i < length) {
            ...
            } else if (Columns.CONTENT_SIZE.equals(obj)) {
                strArr3[i2] = Columns.CONTENT_SIZE;
                i3 = i2 + 1;
