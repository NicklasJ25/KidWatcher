...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C02131();
    ...
    private static final Interpolator sInterpolator = new C02142();
    ...
    private final Runnable mEndScrollRunnable = new C02153();
    ...
    static class C02131 implements Comparator<ItemInfo> {
        C02131() {
        }
    ...
    static class C02142 implements Interpolator {
        C02142() {
        }
    ...
    class C02164 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C02164());
    }
