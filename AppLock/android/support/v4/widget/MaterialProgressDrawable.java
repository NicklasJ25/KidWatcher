...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private final Callback mCallback = new C02363();
    boolean mFinishing;
    ...
    private void setupAnimators() {
        ...
        Animation c02341 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                if (f > 0.5f) {
                    ring.setEndTrim(((MaterialProgressDrawable.MAX_PROGRESS_ARC - minProgressArc) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 0.5f) / 0.5f)) + startingEndTrim);
                }
        ...
        c02341.setRepeatCount(-1);
        c02341.setRepeatMode(1);
        c02341.setInterpolator(LINEAR_INTERPOLATOR);
        c02341.setAnimationListener(new AnimationListener() {
