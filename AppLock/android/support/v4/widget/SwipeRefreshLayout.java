...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    class C02431 implements AnimationListener {
        C02431() {
        }
    ...
    class C02442 extends Animation {
        C02442() {
        }
    ...
    class C02453 extends Animation {
        C02453() {
        }
    ...
    class C02475 implements AnimationListener {
        C02475() {
        }
    ...
    class C02486 extends Animation {
        C02486() {
        }
    ...
    class C02497 extends Animation {
        C02497() {
        }
    ...
    class C02508 extends Animation {
        C02508() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C02431();
        this.mAnimateToCorrectPosition = new C02486();
        this.mAnimateToStartPosition = new C02497();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        ...
        Animation c02464 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c02464.setDuration(300);
        this.mCircleView.setAnimationListener(null);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02464);
        return c02464;
    }
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02508();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C02442();
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C02453();
