...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02421());
        boolean isOpen;

        static class C02421 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C02421() {
            }
        ...
        while (i6 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    layoutParams.dimWhenOffset = ((i7 + i9) + min) + (measuredWidth / 2) > i5 - paddingLeft;
