...
public class Fragment implements ComponentCallbacks, OnCreateContextMenuListener {
    ...
    class C00972 extends FragmentContainer {
        C00972() {
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Creator<SavedState> CREATOR = new C00981();
        final Bundle mState;

        static class C00981 implements Creator<SavedState> {
            C00981() {
            }
    ...
    void instantiateChildFragmentManager() {
        ...
        this.mChildFragmentManager.attachController(this.mHost, new C00972(), this);
    }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new C00961());
        } else {
