...
public class TransportMediator extends TransportController {
    ...
    class C01631 implements TransportMediatorCallback {
        C01631() {
        }
    ...
    class C01642 implements Callback {
        C01642() {
        }
    ...
    private TransportMediator(Activity activity, View view, TransportPerformer transportPerformer) {
        ...
        this.mTransportKeyCallback = new C01631();
        this.mKeyEventCallback = new C01642();
        this.mContext = activity != null ? activity : view.getContext();
        this.mCallbacks = transportPerformer;
        this.mAudioManager = (AudioManager) this.mContext.getSystemService(FileInfo.MIME_AUDIO);
        if (activity != null) {
