...
class TransportMediatorJellybeanMR2 {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C01684();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final OnGetPlaybackPositionListener mGetPlaybackPositionListener = new C01695();
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C01673();
    PendingIntent mPendingIntent;
    int mPlayState = 0;
    final OnPlaybackPositionUpdateListener mPlaybackPositionUpdateListener = new C01706();
    final String mReceiverAction;
    final IntentFilter mReceiverFilter;
    RemoteControlClient mRemoteControl;
    final View mTargetView;
    final TransportMediatorCallback mTransportCallback;
    final OnWindowAttachListener mWindowAttachListener = new C01651();
    final OnWindowFocusChangeListener mWindowFocusListener = new C01662();

    class C01651 implements OnWindowAttachListener {
        C01651() {
        }
    ...
    class C01662 implements OnWindowFocusChangeListener {
        C01662() {
        }
    ...
    class C01673 extends BroadcastReceiver {
        C01673() {
        }
    ...
    class C01684 implements OnAudioFocusChangeListener {
        C01684() {
        }
    ...
    class C01695 implements OnGetPlaybackPositionListener {
        C01695() {
        }
    ...
    class C01706 implements OnPlaybackPositionUpdateListener {
        C01706() {
        }
