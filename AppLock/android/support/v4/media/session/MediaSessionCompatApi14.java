...
class MediaSessionCompatApi14 {
    ...
    public static void registerRemoteControlClient(Context context, Object obj) {
        ((AudioManager) context.getSystemService(FileInfo.MIME_AUDIO)).registerRemoteControlClient((RemoteControlClient) obj);
    }
    ...
    public static void unregisterRemoteControlClient(Context context, Object obj) {
        ((AudioManager) context.getSystemService(FileInfo.MIME_AUDIO)).unregisterRemoteControlClient((RemoteControlClient) obj);
    }
}
