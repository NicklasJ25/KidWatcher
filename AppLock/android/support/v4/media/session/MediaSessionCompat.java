...
public class MediaSessionCompat {
    ...
    class C01771 extends Callback {
        C01771() {
        }
    }

    class C01782 extends Callback {
        C01782() {
        }
    }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C01791();
        VolumeProviderCompat mVolumeProvider;
        int mVolumeType;

        class C01791 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C01791() {
            }
        ...
        class C01802 implements Callback {
            C01802() {
            }
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent) {
            ...
            this.mAudioManager = (AudioManager) context.getSystemService(FileInfo.MIME_AUDIO);
            this.mTag = str;
            ...
            if (this.mIsActive) {
                if (!this.mIsMbrRegistered && (this.mFlags & 1) != 0) {
                    if (VERSION.SDK_INT >= 18) {
                        ...
                        ((AudioManager) this.mContext.getSystemService(FileInfo.MIME_AUDIO)).registerMediaButtonEventReceiver(this.mMediaButtonReceiverComponentName);
                    }
                    ...
                    if (VERSION.SDK_INT >= 18) {
                        ...
                        ((AudioManager) this.mContext.getSystemService(FileInfo.MIME_AUDIO)).unregisterMediaButtonEventReceiver(this.mMediaButtonReceiverComponentName);
                    }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            Object c01802 = new C01802();
            if (VERSION.SDK_INT >= 18) {
                MediaSessionCompatApi18.setOnPlaybackPositionUpdateListener(this.mRccObj, MediaSessionCompatApi18.createPlaybackPositionUpdateListener(c01802));
            }
            if (VERSION.SDK_INT >= 19) {
                MediaSessionCompatApi19.setOnMetadataUpdateListener(this.mRccObj, MediaSessionCompatApi19.createMetadataUpdateListener(c01802));
            }
        }
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01811();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01811 implements Creator<QueueItem> {
            C01811() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01821();
        private ResultReceiver mResultReceiver;

        static class C01821 implements Creator<ResultReceiverWrapper> {
            C01821() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01831();
        private final Object mInner;

        static class C01831 implements Creator<Token> {
            C01831() {
            }
