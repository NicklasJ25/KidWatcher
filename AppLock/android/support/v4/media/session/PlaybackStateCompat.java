...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01851();
    ...
    static class C01851 implements Creator<PlaybackStateCompat> {
        C01851() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01861();
        ...
        static class C01861 implements Creator<CustomAction> {
            C01861() {
            }
