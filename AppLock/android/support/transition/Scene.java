...
public class Scene {
    ...
    public static Scene getSceneForLayout(@NonNull ViewGroup viewGroup, @LayoutRes int i, @NonNull Context context) {
        ...
        SparseArray sparseArray2 = (SparseArray) viewGroup.getTag(C0084R.id.transition_scene_layoutid_cache);
        if (sparseArray2 == null) {
            sparseArray2 = new SparseArray();
            viewGroup.setTag(C0084R.id.transition_scene_layoutid_cache, sparseArray2);
