...
class ChangeBoundsPort extends TransitionPort {
    ...
    class C00771 extends TransitionListenerAdapter {
    ...
    class C00782 extends TransitionListenerAdapter {
        boolean mCanceled = false;
    ...
    class C00793 extends AnimatorListenerAdapter {
        C00793() {
        }
        ...
        if (intValue4 > 0) {
            ...
            if (this.mResizeClip) {
                ...
                if (view.getParent() instanceof ViewGroup) {
                    ...
                    addListener(new C00782());
                }
                ofPropertyValuesHolder.addListener(new C00793());
