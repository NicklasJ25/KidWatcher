...
public final class MultiDex {
    ...
    L_0x001a:
        ...
        throw r0;
    L_0x0045:
        r0 = getApplicationInfo(r6);	 Catch:{ Exception -> 0x005d }
        if (r0 == 0) goto L_0x0015;
    L_0x004b:
        r1 = installedApk;	 Catch:{ Exception -> 0x005d }
        monitor-enter(r1);	 Catch:{ Exception -> 0x005d }
        r2 = r0.sourceDir;	 Catch:{ all -> 0x005a }
        r3 = installedApk;	 Catch:{ all -> 0x005a }
    ...
    L_0x00f7:
        ...
        r5 = SECONDARY_FOLDER_NAME;	 Catch:{ all -> 0x005a }
        r3.<init>(r4, r5);	 Catch:{ all -> 0x005a }
        r4 = 0;
        r4 = android.support.multidex.MultiDexExtractor.load(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r5 = checkValidZipFiles(r4);	 Catch:{ all -> 0x005a }
    ...
    L_0x0121:
        ...
        r4 = 1;
        r0 = android.support.multidex.MultiDexExtractor.load(r6, r0, r3, r4);	 Catch:{ all -> 0x005a }
        r4 = checkValidZipFiles(r0);	 Catch:{ all -> 0x005a }
