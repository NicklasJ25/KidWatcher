...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private final OnGlobalLayoutListener mGlobalLayoutListener = new C02921();
    private boolean mHasXOffset;
    private boolean mHasYOffset;
    private int mLastPosition;
    private final MenuItemHoverListener mMenuItemHoverListener = new C02942();
    ...
    class C02921 implements OnGlobalLayoutListener {
        C02921() {
        }
    ...
    class C02942 implements MenuItemHoverListener {
        C02942() {
        }
        ...
        public void onItemHoverEnter(@NonNull final MenuBuilder menuBuilder, @NonNull final MenuItem menuItem) {
            ...
            if (i != -1) {
                i++;
                final CascadingMenuInfo cascadingMenuInfo = i < CascadingMenuPopup.this.mShowingMenus.size() ? (CascadingMenuInfo) CascadingMenuPopup.this.mShowingMenus.get(i) : null;
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i, @StyleRes int i2, boolean z) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0280R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            ...
            FrameLayout frameLayout = (FrameLayout) from.inflate(C0280R.layout.abc_popup_menu_header_item_layout, listView, false);
