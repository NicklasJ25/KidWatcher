    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) {
        ...
        while (true) {
            ...
            if (depth2 < depth && next == 3) {
                ...
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0280R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0280R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0280R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0280R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0280R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0280R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                ...
                while (i3 < attributeCount) {
                    ...
                    if (depth2 == 16843173 || depth2 == 16843551 || depth2 == C0280R.attr.alpha) {
                        depth2 = i2;
                    } else {
                        int i4 = i2 + 1;
