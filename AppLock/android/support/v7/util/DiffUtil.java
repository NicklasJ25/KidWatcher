...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C02851();

    static class C02851 implements Comparator<Snake> {
        C02851() {
        }

        public int compare(Snake snake, Snake snake2) {
            int i = snake.f15x - snake2.f15x;
            return i == 0 ? snake.f16y - snake2.f16y : i;
        }
    }
    ...
    public static class DiffResult {
        ...
        private void addRootSnake() {
            ...
            if (snake == null || snake.f15x != 0 || snake.f16y != 0) {
                snake = new Snake();
                snake.f15x = 0;
                snake.f16y = 0;
                snake.removal = false;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i8 = snake.f15x + snake.size;
                int i9 = snake.f16y + snake.size;
                if (z) {
                    for (i7--; i7 >= i8; i7--) {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f15x + snake.size;
                int i4 = snake.f16y + snake.size;
                if (this.mDetectMoves) {
                    while (i > i3) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            while (size >= 0) {
                Snake snake = (Snake) this.mSnakes.get(size);
                int i3 = snake.size;
                int i4 = snake.f15x + i3;
                int i5 = snake.f16y + i3;
                if (i4 < i) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f15x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f15x + i6, 1, this.mCallback.getChangePayload(snake.f15x + i6, snake.f16y + i6));
                    }
                }
                i = snake.f15x;
                size--;
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f15x += range.oldListStart;
                diffPartial.f16y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f15x;
                    range2.newListEnd = diffPartial.f16y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f15x - 1;
                    range2.newListEnd = diffPartial.f16y;
                } else {
                    range2.oldListEnd = diffPartial.f15x;
                    range2.newListEnd = diffPartial.f16y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f15x + diffPartial.size;
                    range.newListStart = diffPartial.f16y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = (diffPartial.f15x + diffPartial.size) + 1;
                    range.newListStart = diffPartial.f16y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f15x + diffPartial.size;
                    range.newListStart = (diffPartial.f16y + diffPartial.size) + 1;
                }
        ...
        while (i10 <= i9) {
            ...
            while (i12 <= i10) {
                ...
                if (obj == null || i12 < (i8 - i10) + 1 || i12 > (i8 + i10) - 1 || iArr[i5 + i12] < iArr2[i5 + i12]) {
                    ...
                    snake.f15x = iArr2[i5 + i12];
                    snake.f16y = snake.f15x - i12;
            ...
            while (i12 <= i10) {
                ...
                if (obj != null || i12 + i8 < (-i10) || i12 + i8 > i10 || iArr[i5 + i14] < iArr2[i5 + i14]) {
                    ...
                    snake = new Snake();
                    snake.f15x = iArr2[i5 + i14];
                    snake.f16y = snake.f15x - i14;
