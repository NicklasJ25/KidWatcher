...
*/
    ...
    L_0x000a:
        ...
        r3 = android.support.v7.appcompat.C0280R.styleable.AppCompatImageView;	 Catch:{ all -> 0x003c }
        r4 = 0;	 Catch:{ all -> 0x003c }
        r1 = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(r2, r7, r3, r8, r4);	 Catch:{ all -> 0x003c }
        r2 = android.support.v7.appcompat.C0280R.styleable.AppCompatImageView_srcCompat;	 Catch:{ all -> 0x003c }
