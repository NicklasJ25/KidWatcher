...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent {
    static final int[] ATTRS = new int[]{C0280R.attr.actionBarSize, 16842841};
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.ACTION_BAR_ANIMATE_DELAY = PositionController.SNAPBACK_ANIMATION_TIME;
        this.mTopAnimatorListener = new C03001();
        this.mRemoveActionBarHideOffset = new C03012();
        this.mAddActionBarHideOffset = new C03023();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0280R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0280R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0280R.id.action_bar));
        }
    }
