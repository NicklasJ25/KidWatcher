...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class C03122 implements OnGlobalLayoutListener {
            C03122() {
            }
        ...
        public void show() {
            ...
            if (!isShowing) {
                ...
                if (viewTreeObserver != null) {
                    final OnGlobalLayoutListener c03122 = new C03122();
                    viewTreeObserver.addOnGlobalLayoutListener(c03122);
                    setOnDismissListener(new OnDismissListener() {
                        public void onDismiss() {
                            ViewTreeObserver viewTreeObserver = AppCompatSpinner.this.getViewTreeObserver();
                            if (viewTreeObserver != null) {
                                viewTreeObserver.removeGlobalOnLayoutListener(c03122);
                            }
                        }
                    });
                }
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0280R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0280R.attr.spinnerStyle);
    }
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Theme theme) {
        ...
        TintTypedArray obtainStyledAttributes3 = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0280R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, theme);
        } else {
            int resourceId = obtainStyledAttributes3.getResourceId(C0280R.styleable.Spinner_popupTheme, 0);
            if (resourceId != 0) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if (i2 == 1) {
                                    ...
                                    obtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0280R.styleable.Spinner, i, 0);
                                    this.mDropDownWidth = obtainStyledAttributes2.getLayoutDimension(C0280R.styleable.Spinner_android_dropDownWidth, -2);
                                    dropdownPopup.setBackgroundDrawable(obtainStyledAttributes2.getDrawable(C0280R.styleable.Spinner_android_popupBackground));
                                    dropdownPopup.setPromptText(obtainStyledAttributes3.getString(C0280R.styleable.Spinner_android_prompt));
                                ...
                                textArray = obtainStyledAttributes3.getTextArray(C0280R.styleable.Spinner_android_entries);
                                if (textArray != null) {
                                    arrayAdapter = new ArrayAdapter(context, 17367048, textArray);
                                    arrayAdapter.setDropDownViewResource(C0280R.layout.support_simple_spinner_dropdown_item);
