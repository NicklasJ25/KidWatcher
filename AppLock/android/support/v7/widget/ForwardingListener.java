...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C03251 implements OnAttachStateChangeListener {
        C03251() {
        }
    ...
    class C03262 implements OnGlobalLayoutListener {
    ...
    private void addDetachListenerApi12(View view) {
        view.addOnAttachStateChangeListener(new C03251());
    }

    private void addDetachListenerBase(View view) {
        view.getViewTreeObserver().addOnGlobalLayoutListener(new C03262());
    }
