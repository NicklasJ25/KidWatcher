...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C03051 extends DataSetObserver {
        C03051() {
        }
    ...
    class C03084 extends DataSetObserver {
        C03084() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0280R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0280R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0280R.id.icon)).setImageDrawable(resolveInfo.loadIcon(packageManager));
                    ((TextView) view.findViewById(C0280R.id.title)).setText(resolveInfo.loadLabel(packageManager));
                ...
                case 1:
                    ...
                    view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0280R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    view.setId(1);
                    ((TextView) view.findViewById(C0280R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0280R.string.abc_activity_chooser_view_see_all));
                    return view;
                default:
                    throw new IllegalArgumentException();
            }
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetObserver = new C03051();
        this.mOnGlobalLayoutListener = new C03062();
        this.mInitialActivityCount = 4;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0280R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = obtainStyledAttributes.getInt(C0280R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable drawable = obtainStyledAttributes.getDrawable(C0280R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        obtainStyledAttributes.recycle();
        LayoutInflater.from(getContext()).inflate(C0280R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0280R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0280R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0280R.id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0280R.id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0280R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(drawable);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C03084());
        Resources resources = context.getResources();
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C0280R.dimen.abc_config_prefDialogWidth));
    }
    ...
    void showPopupUnchecked(int i) {
        ...
        if (!listPopupWindow.isShowing()) {
            ...
            listPopupWindow.getListView().setContentDescription(getContext().getString(C0280R.string.abc_activitychooserview_choose_application));
        }
    }
