...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C03535 implements OnLayoutChangeListener {
        C03535() {
        }
    ...
    class C03546 implements OnGlobalLayoutListener {
        C03546() {
        }
    ...
    class C03557 implements OnClickListener {
        C03557() {
        }
    ...
    class C03568 implements OnKeyListener {
        C03568() {
        }
    ...
    class C03579 implements OnEditorActionListener {
        C03579() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03581());
        boolean isIconified;

        static class C03581 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03581() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0280R.attr.autoCompleteTextViewStyle);
        }
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            return (screenWidthDp < 960 || screenHeightDp < 720 || configuration.orientation != 2) ? (screenWidthDp >= PositionController.SNAPBACK_ANIMATION_TIME || (screenWidthDp >= 640 && screenHeightDp >= 480)) ? 192 : 160 : 256;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mShowImeRunnable = new C03491();
        this.mUpdateDrawableStateRunnable = new C03502();
        this.mReleaseCursorRunnable = new C03513();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C03557();
        this.mTextKeyListener = new C03568();
        this.mOnEditorActionListener = new C03579();
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0280R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0280R.styleable.SearchView_layout, C0280R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0280R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0280R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0280R.id.search_plate);
        this.mSubmitArea = findViewById(C0280R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0280R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0280R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0280R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0280R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0280R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = obtainStyledAttributes.getDrawable(C0280R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = obtainStyledAttributes.getResourceId(C0280R.styleable.SearchView_suggestionRowLayout, C0280R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = obtainStyledAttributes.getResourceId(C0280R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C03524());
        setIconifiedByDefault(obtainStyledAttributes.getBoolean(C0280R.styleable.SearchView_iconifiedByDefault, true));
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0280R.styleable.SearchView_android_maxWidth, -1);
        if (dimensionPixelSize != -1) {
            setMaxWidth(dimensionPixelSize);
        }
        this.mDefaultQueryHint = obtainStyledAttributes.getText(C0280R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = obtainStyledAttributes.getText(C0280R.styleable.SearchView_queryHint);
        dimensionPixelSize = obtainStyledAttributes.getInt(C0280R.styleable.SearchView_android_imeOptions, -1);
        if (dimensionPixelSize != -1) {
            setImeOptions(dimensionPixelSize);
        }
        dimensionPixelSize = obtainStyledAttributes.getInt(C0280R.styleable.SearchView_android_inputType, -1);
        if (dimensionPixelSize != -1) {
            setInputType(dimensionPixelSize);
        }
        setFocusable(obtainStyledAttributes.getBoolean(C0280R.styleable.SearchView_android_focusable, true));
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C03546());
    }

    @TargetApi(11)
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C03535());
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0280R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0280R.dimen.abc_dropdownitem_icon_width) : 0;
