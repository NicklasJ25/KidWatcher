    ...
    public void runPendingAnimations() {
        ...
        if (i != 0 || i2 != 0 || i4 != 0 || i3 != 0) {
            ...
            if (i2 != 0) {
                ...
                if (i != 0) {
                    ViewCompat.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, c03171, getRemoveDuration());
                } else {
                    c03171.run();
                }
            }
            if (i3 != 0) {
                ...
                if (i != 0) {
                    ViewCompat.postOnAnimationDelayed(((ChangeInfo) arrayList.get(0)).oldHolder.itemView, c03171, getRemoveDuration());
                } else {
                    c03171.run();
                }
            }
            if (i4 != 0) {
                ...
                if (i == 0 && i2 == 0 && i3 == 0) {
                    ...
                    ViewCompat.postOnAnimationDelayed(((ViewHolder) arrayList2.get(0)).itemView, c03193, (i != 0 ? getRemoveDuration() : 0) + Math.max(i2 != 0 ? getMoveDuration() : 0, i3 != 0 ? getChangeDuration() : 0));
                }
            }
        }
    }
