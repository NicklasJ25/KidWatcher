...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat implements OnLongClickListener {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0280R.attr.actionBarTabStyle);
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0280R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (z) {
                if (this.mTextView == null) {
                    appCompatImageView = new AppCompatTextView(getContext(), null, C0280R.attr.actionBarTabTextStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0280R.attr.actionDropDownStyle);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0280R.attr.actionBarTabBarStyle);
