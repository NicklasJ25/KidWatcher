...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0280R.drawable.abc_popup_background_mtrl_mult, C0280R.drawable.abc_cab_background_internal_bg, C0280R.drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0280R.drawable.abc_textfield_activated_mtrl_alpha, C0280R.drawable.abc_textfield_search_activated_mtrl_alpha, C0280R.drawable.abc_cab_background_top_mtrl_alpha, C0280R.drawable.abc_text_cursor_material, C0280R.drawable.abc_text_select_handle_left_mtrl_dark, C0280R.drawable.abc_text_select_handle_middle_mtrl_dark, C0280R.drawable.abc_text_select_handle_right_mtrl_dark, C0280R.drawable.abc_text_select_handle_left_mtrl_light, C0280R.drawable.abc_text_select_handle_middle_mtrl_light, C0280R.drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0280R.drawable.abc_textfield_search_default_mtrl_alpha, C0280R.drawable.abc_textfield_default_mtrl_alpha, C0280R.drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = new int[]{C0280R.drawable.abc_btn_check_material, C0280R.drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = new int[]{C0280R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0280R.drawable.abc_seekbar_tick_mark_material, C0280R.drawable.abc_ic_menu_share_mtrl_alpha, C0280R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0280R.drawable.abc_ic_menu_cut_mtrl_alpha, C0280R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0280R.drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0280R.drawable.abc_tab_indicator_material, C0280R.drawable.abc_textfield_search_material};
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable drawable = getDrawable(context, C0280R.drawable.abc_vector_test);
    ...
    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        r0 = new int[4][];
        r1 = new int[4];
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlHighlight);
        int disabledThemeAttrColor = ThemeUtils.getDisabledThemeAttrColor(context, C0280R.attr.colorButtonNormal);
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorAccent));
    }

    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorButtonNormal));
    }
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (cachedDrawable == null) {
            if (i == C0280R.drawable.abc_cab_background_top_material) {
                cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0280R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0280R.drawable.abc_cab_background_top_mtrl_alpha)});
            }
            if (cachedDrawable != null) {
    ...
    static Mode getTintMode(int i) {
        return i == C0280R.drawable.abc_switch_thumb_material ? Mode.MULTIPLY : null;
    }
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (i == C0280R.drawable.abc_seekbar_track_material) {
            r0 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else if (i != C0280R.drawable.abc_ratingbar_material && i != C0280R.drawable.abc_ratingbar_indicator_material && i != C0280R.drawable.abc_ratingbar_small_material) {
            return (tintDrawableUsingColorFilter(context, i, drawable) || !z) ? drawable : null;
        } else {
            r0 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0280R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(r0.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0280R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        }
    }
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i)) {
            i2 = C0280R.attr.colorControlNormal;
            mode = mode2;
            z = true;
            i3 = -1;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, i)) {
            i2 = C0280R.attr.colorControlActivated;
            mode = mode2;
            z = true;
            i3 = -1;
            ...
            i2 = 16842801;
            i3 = -1;
        } else if (i == C0280R.drawable.abc_list_divider_mtrl_alpha) {
            i2 = 16842800;
            i3 = Math.round(40.8f);
            mode = mode2;
            z = true;
        } else if (i == C0280R.drawable.abc_dialog_material_background) {
            i2 = 16842801;
            mode = mode2;
            z = true;
            i3 = -1;
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int i) {
        ...
        if (tintListFromCache == null) {
            if (i == C0280R.drawable.abc_edit_text_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_edittext);
            } else if (i == C0280R.drawable.abc_switch_track_mtrl_alpha) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_switch_track);
            } else if (i == C0280R.drawable.abc_switch_thumb_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_switch_thumb);
            } else if (i == C0280R.drawable.abc_btn_default_mtrl_shape) {
                tintListFromCache = createDefaultButtonColorStateList(context);
            } else if (i == C0280R.drawable.abc_btn_borderless_material) {
                tintListFromCache = createBorderlessButtonColorStateList(context);
            } else if (i == C0280R.drawable.abc_btn_colored_material) {
                tintListFromCache = createColoredButtonColorStateList(context);
            } else if (i == C0280R.drawable.abc_spinner_mtrl_am_alpha || i == C0280R.drawable.abc_spinner_textfield_background_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_spinner);
            } else if (arrayContains(TINT_COLOR_CONTROL_NORMAL, i)) {
                tintListFromCache = ThemeUtils.getThemeAttrColorStateList(context, C0280R.attr.colorControlNormal);
            } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, i)) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_default);
            } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, i)) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_btn_checkable);
            } else if (i == C0280R.drawable.abc_seekbar_thumb_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0280R.color.abc_tint_seek_thumb);
            }
            if (tintListFromCache != null) {
