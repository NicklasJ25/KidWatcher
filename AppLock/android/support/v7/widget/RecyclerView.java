...
import android.support.v7.recyclerview.C0282R;
...
public class RecyclerView extends ViewGroup implements NestedScrollingChild, ScrollingView {
    ...
    static final Interpolator sQuinticInterpolator = new C03403();
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C03441();
        ...
        private final Callback mVerticalBoundCheckCallback = new C03452();
        private int mWidth;
        ...
        class C03441 implements Callback {
            C03441() {
            }
        ...
        class C03452 implements Callback {
            C03452() {
            }
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0282R.styleable.RecyclerView, i, i2);
            properties.orientation = obtainStyledAttributes.getInt(C0282R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(C0282R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(C0282R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(C0282R.styleable.RecyclerView_stackFromEnd, false);
    ...
    static class C03403 implements Interpolator {
        C03403() {
        }
    ...
    class C03414 implements ProcessCallback {
        C03414() {
        }
    ...
    class C03425 implements Callback {
        C03425() {
        }
    ...
    class C03436 implements Callback {
        C03436() {
        }
    ...
    public final class Recycler {
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout() && changedScrapViewForPosition.isBound()) {
                ...
                z3 = (!changedScrapViewForPosition.isBound() || changedScrapViewForPosition.needsUpdate() || changedScrapViewForPosition.isInvalid()) ? tryBindViewHolderByDeadline(changedScrapViewForPosition, RecyclerView.this.mAdapterHelper.findPositionOffset(i), i, j) : false;
            }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C03461());
        Parcelable mLayoutState;

        static class C03461 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C03461() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C03381();
        ...
        this.mItemAnimatorRunner = new C03392();
        this.mViewInfoProcessCallback = new C03414();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0282R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0282R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0282R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C03425());
    }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C03436());
    }
                ...
                case 2:
                    ...
                    if (actionMasked >= 0) {
                        ...
                        if (this.mScrollState == 1) {
                            ...
                            if (scrollByInternal(canScrollHorizontally ? i : 0, canScrollVertically ? actionMasked : 0, obtain)) {
                                getParent().requestDisallowInterceptTouchEvent(true);
                            }
