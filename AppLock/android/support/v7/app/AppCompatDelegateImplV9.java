...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C02651();
    ...
    class C02662 implements OnApplyWindowInsetsListener {
        C02662() {
        }
    ...
    class C02673 implements OnFitSystemWindowsListener {
        C02673() {
        }
    ...
    class C02684 implements OnAttachListener {
        C02684() {
        }
    ...
    class C02705 implements Runnable {
        ...
        class C02691 extends ViewPropertyAnimatorListenerAdapter {
            C02691() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02691());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    class C02716 extends ViewPropertyAnimatorListenerAdapter {
        C02716() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C02721());
            }
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02731());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C02731 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02731() {
                }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0280R.layout.abc_list_menu_item_layout);
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0280R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0280R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0280R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray obtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0280R.styleable.AppCompatTheme);
            this.background = obtainStyledAttributes.getResourceId(C0280R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = obtainStyledAttributes.getResourceId(C0280R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0280R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0280R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0280R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0280R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0280R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0280R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
    ...
    private ViewGroup createSubDecor() {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0280R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0280R.styleable.AppCompatTheme_windowActionBar)) {
            View view;
            if (obtainStyledAttributes.getBoolean(C0280R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0280R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (obtainStyledAttributes.getBoolean(C0280R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (obtainStyledAttributes.getBoolean(C0280R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0280R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                View view2 = this.mOverlayActionMode ? (ViewGroup) from.inflate(C0280R.layout.abc_screen_simple_overlay_action_mode, null) : (ViewGroup) from.inflate(C0280R.layout.abc_screen_simple, null);
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view2, new C02662());
                    view = view2;
                } else {
                    ((FitWindowsViewGroup) view2).setOnFitSystemWindowsListener(new C02673());
                    view = view2;
                }
            } else if (this.mIsFloating) {
                r0 = (ViewGroup) from.inflate(C0280R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
                view = r0;
            } else if (this.mHasActionBar) {
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0280R.attr.actionBarTheme, typedValue, true);
                r0 = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new ContextThemeWrapper(this.mContext, typedValue.resourceId) : this.mContext).inflate(C0280R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) r0.findViewById(C0280R.id.decor_content_parent);
            ...
            if (this.mDecorContentParent == null) {
                this.mTitleView = (TextView) view.findViewById(C0280R.id.title);
            }
            ViewUtils.makeOptionalFitsSystemWindows(view);
            ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0280R.id.action_bar_activity_content);
            ...
            contentFrameLayout.setAttachListener(new C02684());
            return view;
        }
        obtainStyledAttributes.recycle();
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0280R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0280R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0280R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        if (z) {
            AudioManager audioManager = (AudioManager) this.mContext.getSystemService(FileInfo.MIME_AUDIO);
        ...
        if (actionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(contextThemeWrapper, null, C0280R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    contextThemeWrapper.getTheme().resolveAttribute(C0280R.attr.actionBarSize, typedValue, true);
                    ...
                    this.mShowActionModePopup = new C02705();
                } else {
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0280R.id.action_mode_bar_stub);
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C02716());
                    } else {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0280R.color.abc_input_method_navigation_guard));
