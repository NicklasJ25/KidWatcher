...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C02762();
    private final Runnable mMenuInvalidator = new C02751();
    ...
    class C02762 implements OnMenuItemClickListener {
        C02762() {
        }
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(contextThemeWrapper, C0280R.layout.abc_list_menu_item_layout);
