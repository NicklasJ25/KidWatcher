...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C02771();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C02782();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C02793();

    class C02771 extends ViewPropertyAnimatorListenerAdapter {
        C02771() {
        }
    ...
    class C02782 extends ViewPropertyAnimatorListenerAdapter {
        C02782() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0280R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0280R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0280R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0280R.id.action_bar_container);
        ...
        z = actionBarPolicy.enableHomeButtonByDefault() || z;
        ...
        if (obtainStyledAttributes.getBoolean(C0280R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0280R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0280R.attr.actionBarWidgetTheme, typedValue, true);
